...
public class MemberController implements MemberApi {
    ...
    @Override
    public ResponseEntity<StandardResponse<MemberUpdateResponse>> update(String memberId, MemberUpdateRequest request) {
        MemberResult result = memberCommandService.update(Long.parseLong(memberId), request.toCommand());

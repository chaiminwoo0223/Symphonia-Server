...
public class ValidationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleExceptionInternal(
        ...
        return super.handleExceptionInternal(
                ex,
                toStandardResponse(CommonErrorCode.INTERNAL_SERVER_ERROR),
                headers,
                statusCode,
                request);
    }
    ...
    public ResponseEntity<Object> handleConstraintViolationException(
        ...
        List<ValidationErrorResponse> violations =
                ex.getConstraintViolations().stream().map(this::toValidationErrorResponse).toList();
    ...
    private ResponseEntity<Object> buildErrorResponse(ErrorCode errorCode) {
        return ResponseEntity.status(errorCode.getStatus()).body(toStandardResponse(errorCode));
    }

    private ResponseEntity<Object> buildValidationResponse(
            ErrorCode errorCode, List<ValidationErrorResponse> violations) {
    ...
    private StandardResponse<ErrorResponse> toStandardResponse(
            ErrorCode errorCode, List<ValidationErrorResponse> violations) {
        return StandardResponse.fail(
                errorCode.getStatus(), ErrorResponse.of(errorCode, violations));
    }
